1. RecordParser solution is created in Visual Studio 2017. Target framework: .NET Framework 4.6.1.

2. RecordParser solution contains 4 projects:
...
2) FavoriteColor value does not require validation;
3) Persistence datastore is not required for the web Service.
